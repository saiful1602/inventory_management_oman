...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Saqar Cost Entry Update</title>
    <!-- Boxiocns CDN Link -->
...
<body>
	...
	?>
     <div style="padding-top:1rem;" class="container col-lg-10 rounded-3 text-center" style="background: white;">
      <label class="text-center fs-2 mb-3 headline2">Saqar Cost Entry Update</label>
        ...
        <table id="table" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
              ...
              $sel="SELECT `invoice_no`,`cost_details`,TRUNCATE(`amount`,3) AS amount,`date`
                    FROM `saqar_cost_entry` WHERE `invoice_no`='$invoice'";
    ...
    <div id="tableDiv" class="container col-lg-10 rounded-3 text-center" style="background: #4a91bd;padding-top:2rem; ">
      ...
      <div class="row mx-auto text-center mb-3">
        ...
        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
          ...
          <input type="text" class="col-lg-8 col-md-10 col-sm-12 form-control" id="costDetails" placeholder=" " maxlength="50" >
        </div>
  ...
  <script>
    ...
    function clearForm(){
      ...
      var costDetails=currentRow.find("td:eq(2)").text(); 
    ...
    $(document).on('click','#updateBtn',function(){
      ...
      if(datepicker !="" && txtInvoice !="" && costDetails !="" && txtAmount !=""){

        $.ajax({
          url: 'saqarCostUpdate.php',
          type: "POST",
          data:{
          ...
          success:function(response){
            swal({
                ...
                window.location ="saqarCostAdmin.php?invoice="+txtInvoice;
