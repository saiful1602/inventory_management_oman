...
<body style="background: #32aba9">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#">4. Customer Ledger</a></li>
  ...
  <section class="home-section" style="background: #32aba9;">
    ...
    <div class="container col-lg-10 rounded-3 text-center" style="background: #4a91bd; ">
      <label class="text-center fs-2 mb-3 headline">Customer Ledger</label>
      ...
      <div class="row mx-auto text-center mb-3">
        ...
        <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
          <label class="form-label fs-5 headline">Note : For All Information Please Select Address & Name Only</label><br>
        </div>
  ...
  <script>
    ...
    $('#curTime').text("Print Time : " + time.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true }));
	  ...
	  $('#searchBtn').on('click',function(){
        ...
        var myWindow = window.open('print_customer_ledger.php?date1='+ date1 +'&date2='+ date2 + '&cusAddress='+ cusAddress +'&cusName='+ cusName, 'Customer Ledger',
        ...
        var myWindow = window.open('print_customer_ledger.php?date1='+ date1 +'&date2='+ date2 + '&cusAddress='+ cusAddress +'&cusName='+ cusName,
             'Parts Sales Report',
            'resizable=yes, width=' + '800'
            + ', height=' + '700' + ', top='
            + top + ', left=' + left);
