...
<body style="background: #32aba9">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#">5. Supplier Ledger</a></li>
  ...
  <section class="home-section" style="background: #32aba9;">
    ...
    <div class="container col-lg-10 rounded-3 text-center" style="background: #4a91bd; ">
      <label class="text-center fs-2 mb-3 headline">Supplier Ledger</label>
  ...
  <script>
    ...
    $('#curTime').text("Print Time : " + time.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true }));
	  ...
	  $('#searchBtn').on('click',function(){
        ...
        var myWindow = window.open('print_supplier_ledger.php?date1='+ date1 +'&date2='+ date2 + '&supAddress='+ supAddress +'&supName='+ supName, 
          'Supplier Ledger',
