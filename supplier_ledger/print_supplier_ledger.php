...
<body>
    ...
    <div class="container col-lg-10 rounded-3 text-center" style="background: white;">
      ...
      <div class="row overflow-scroll divScroll">
       <table id="table" class="table table-striped table-bordered">
          ...
          <h3 class="headline3">Supplier Ledger</h3>
          <div style="width:100%;" class="d-flex col-lg-12 col-md-12 col-sm-12 text-center">
            <h6 style="width:33%;text-align: center;" id="printSupAddress" class="headline2 col-lg-6">Address : <?php echo $supAddress; ?></h6>
            <h6 style="width:33%;text-align: center;" id="printSupName" class="headline2 col-lg-6">Name : <?php echo $supName; ?></h6>
            <h6 style="width:33%;text-align: center;" id="printSupMobile" class="headline2 col-lg-6">Tel :</h6>
          </div>
          <?php
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      var supAddress = <?php echo json_encode($supAddress); ?>;
      var supName = <?php echo json_encode($supName); ?>;

        var left = (screen.width - 1200) / 2;
        var top = (screen.height - 700) / 4;

      if(date1 == "" && date2 == "" && supAddress != "" && supName != ""){
        $.ajax({
          url : "supLedSelect.php",
          type : "GET",
          data: { 
            'supName' : supName,
        ...
        success : function(data){
           ...
           $('#printSupMobile').text("Tel : "+data);
        }
        });

      }else if(supAddress != "" && supName != "" && date1 != "" && date2 != ""){
          $.ajax({
          url : "supLedSelect2.php",
          type : "GET",
          data: { 
            'date1' : date1,
            'date2' : date2,
